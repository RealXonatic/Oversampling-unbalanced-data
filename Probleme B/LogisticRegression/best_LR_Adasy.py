...
def plot_pca_and_metrics_with_adasyn(df, n_iterations=20):
    ...
    for i in range(n_iterations):
        ...
        # Training the best logistic regression model without ADASYN on all training data
        best_model_lr = grid_search_lr.best_estimator_
        best_model_lr.fit(X_train_pca, y_train)

        # Predicting and evaluating on test data for logistic regression without ADASYN
        ...
        param_grid = {
            'adasyn__n_neighbors':[10, 20 , 30, 40, 50, 60],
    ...
    plt.tight_layout()
    plt.savefig('visualisation_pca_adasyn_logistic_regression.png')
    plt.show()
...
print("Results saved to 'combined_results_adasyn.csv' and PCA visualizations saved as 'visualisation_pca_adasyn_logistic_regression.png'")